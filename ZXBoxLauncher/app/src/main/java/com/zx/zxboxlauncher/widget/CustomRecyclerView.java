package com.zx.zxboxlauncher.widget;
            ...
            switch (event.getKeyCode()) {
                case KeyEvent.KEYCODE_DPAD_RIGHT:
                    ...
                    if (event.getAction() == KeyEvent.ACTION_UP) {
                        ...
                        Logger.getLogger().i("rightView is null:" + (rightView == null));
                        if (rightView != null) {
                            Logger.getLogger().i("CustomRecyclerView.requestFocusFromTouch.");
...
//        Logger.getLogger().i(this, "CustomRecyclerView.onScrolled.");
    ...
    public boolean isLastItemVisible(int lineNum, int allItemNum) {
        ...
        LayoutManager layoutManager = getLayoutManager();
        if (layoutManager instanceof StaggeredGridLayoutManager) {
//            Logger.getLogger().i(this, "lastVisiblePosition:" + position);
...
//            Logger.getLogger().i(this,"HomeTvAdapter.onCreateViewHolder.");
...
//            Logger.getLogger().i(this,"HomeTvAdapter.onBindViewHolder.");
                ...
                public boolean onHover(View v, MotionEvent event) {
                    ...
                    switch (what) {
                        case MotionEvent.ACTION_HOVER_ENTER:
                            ...
                            int x = location[0];
//                            Logger.getLogger().i("swj","GalleryAdapter.onHover.x="+x +",width = "+(recyclerView.getWidth()+x));
                            ...
                            if (recyclerView.getScrollState() == RecyclerView.SCROLL_STATE_IDLE) {
                                ...
                                v.requestFocus();
//                                Logger.getLogger().i(this,"HomeTvAdapter.onHover.position:"+position);
