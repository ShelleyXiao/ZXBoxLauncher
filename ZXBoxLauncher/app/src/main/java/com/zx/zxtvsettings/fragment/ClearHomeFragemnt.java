...
public class ClearHomeFragemnt extends BaseFragment implements AdapterView.OnItemClickListener, ClearDetailAdapter.itemCheckedChangedListener{
    ...
    @OnClick({R.id.system_cache, R.id.temp_file, R.id.apk_zip, R.id.big_file, R.id.software_last, R.id.empty_folder, R.id.thumb})
