...
//                ((ClearDetialActivity) mContext).selectAll.setChecked(false);
    ...
    static class ViewHolder {
        @BindView(R.id.detial_item_icon)
        ImageView mDetialItemIcon;
        @BindView(R.id.detial_item_name)
        TextView mDetialItemName;
        @BindView(R.id.detial_item_state)
        TextView mDetialItemState;
        @BindView(R.id.detial_item_size)
        TextView mDetialItemSize;
        @BindView(R.id.detial_item_version)
        TextView mDetialItemVersion;
        @BindView(R.id.detial_item_selected)
        CheckBox mDetialItemSelected;
        @BindView(R.id.detial_item_layout)
