...
import com.zx.zxboxlauncher.utils.Tools;
...
public class AppUninstallActivity extends BaseActivity implements AdapterView.OnItemClickListener{

    @BindView(R.id.app_uninstall_lv)
