...
enum Data_Id {
	sWIFI_IP_ID, sWIFI_MASK_ID, sWIFI_GATE_ID, sWIFI_DNS1_ID, sWIFI_DNS2_ID, sWIFI_MAC_ID, sETHERNET_IP_ID, sETHERNET_MASK_ID, sETHERNET_GATE_ID, sETHERNET_DNS1_ID, sETHERNET_DNS2_ID, sETHERNET_MAC_ID, sPPPOE_IP_ID, sPPPOE_MASK_ID, sPPPOE_GATE_ID, sPPPOE_DNS1_ID, sPPPOE_DNS2_ID, sPPPOE_MAC_ID, iWIFI_IP_ID, iWIFI_MASK_ID, iWIFI_GATE_ID, iWIFI_DNS1_ID, iWIFI_DNS2_ID, iETHERNET_IP_ID, iETHERNET_MASK_ID, iETHERNET_GATE_ID, iETHERNET_DNS1_ID, iETHERNET_DNS2_ID,
};

enum NetType {
	TYPE_NONE, TYPE_WIFI, TYPE_ETHERNET, TYPE_PPPOE,
...
public class NetState {
	...
	public Integer getNetState(Data_Id id) {
		Integer retval = -1;
		switch (id) {
		case iWIFI_IP_ID:
	...
	public String getNetStateString(Data_Id id) {
		String retval = "error";
		switch (id) {
		case sWIFI_IP_ID:
	...
	public void setNetState(Data_Id id, Integer value) {
		switch (id) {
		case iWIFI_IP_ID:
	...
	public void setNetStateString(Data_Id id, String value) {
		switch (id) {
		case sWIFI_IP_ID:
